...
export const LOCAL_ASSET_REGISTRY: Record<string, RegisteredAsset> = {
    "scene:office:default": {
        key: "scene:office:default",
        role: "scenePlate",
        tags: ["office", "desk", "screen", "work", "room"],
        width: 1920,
        height: 1080,
        compositeMode: "replace-background",
        source: { kind: "local-svg", library: "scene-pack", path: "assets/scene-plates/office/default.svg", license: CC0 },
    },
    "scene:kitchen:default": {
        key: "scene:kitchen:default",
        role: "scenePlate",
        tags: ["kitchen", "counter", "morning", "room"],
        width: 1920,
        height: 1080,
        compositeMode: "replace-background",
        source: { kind: "local-svg", library: "scene-pack", path: "assets/scene-plates/kitchen/default.svg", license: CC0 },
    },
    "scene:living-room:default": {
        key: "scene:living-room:default",
        role: "scenePlate",
        tags: ["living-room", "sofa", "home", "room"],
        width: 1920,
        height: 1080,
        compositeMode: "replace-background",
        source: { kind: "local-svg", library: "scene-pack", path: "assets/scene-plates/living-room/default.svg", license: CC0 },
    },
    "scene:hallway:default": {
        key: "scene:hallway:default",
        role: "scenePlate",
        tags: ["hallway", "doorway", "transition", "room"],
        width: 1920,
        height: 1080,
        compositeMode: "replace-background",
        source: { kind: "local-svg", library: "scene-pack", path: "assets/scene-plates/hallway/default.svg", license: CC0 },
    },
