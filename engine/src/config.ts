...
export const CREDENTIALS: CredentialSpec[] = [
  {
    ...
    fallback: "when fail-open is enabled, reasoning uses direct OpenAI instead",
  },
  {
    key: "LLM_ROUTER_MODE",
    ...
    secret: false,
    placeholder: "freellmapi",
    help: "Use freellmapi for free-first inference, or direct for immediate OpenAI rollback.",
  ...
  },
  {
    ...
    secret: false,
    placeholder: "true",
    help: "When true, a FreeLLMAPI outage/quota/error retries the same request through direct OpenAI.",
    fallback: "true",
  },
  {
    ...
    help: "Docker-internal URL of the shared FreeLLMAPI service.",
  ...
  },
  {
    ...
    secret: true,
    placeholder: "sk-…",
    help: "Paid fail-open and LLM_ROUTER_MODE=direct credential.",
    fallback: "optional when FreeLLMAPI is configured; without it a FreeLLMAPI outage cannot fail open",
  },
  {
    key: "OPENAI_MODEL",
    ...
    help: "Paid OpenAI model used only for fail-open/direct mode.",
  ...
  },
  {
    ...
    secret: true,
    placeholder: "fal key",
    help: "Used to generate every illustrated still and the thumbnail artwork (RFC 0008). There is no deterministic fallback renderer for scenes.",
    fallback: "every scene degrades to a placeholder; thumbnail art falls back to the renderer background",
  },
  {
    key: "PEXELS_API_KEY",
