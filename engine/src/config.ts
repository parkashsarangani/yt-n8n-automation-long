...
export const CREDENTIALS: CredentialSpec[] = [
  ...
  },
  {
    ...
    secret: false,
    placeholder: "auto",
    help: "FreeLLMAPI image media-registry selector. Use auto unless you have verified an exact enabled image model id from /api/media.",
    fallback: "auto",
  },
  {
  ...
  },
  {
    ...
    secret: false,
    placeholder: "auto",
    help: "FreeLLMAPI audio media-registry selector. Auto is portable across catalog revisions; deployment smoke records the provider that actually answered.",
    fallback: "auto",
  },
  {
  ...
  },
  {
    ...
    secret: false,
    placeholder: "mp3",
    help: "Preferred format sent to FreeLLMAPI. Providers may legitimately return another real audio type (Google currently returns WAV); the voice artifact persists the actual response type.",
