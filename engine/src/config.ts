...
export const CREDENTIALS: CredentialSpec[] = [
  {
    ...
    help: "Unified key from the shared FreeLLMAPI instance. Long uses it for pinned-Gemini text reasoning and, when explicitly selected, optional FreeLLM speech. It is never used as RFC 0010 visual evidence or for image generation.",
    fallback: "reasoning can use paid OpenAI fail-open; optional FreeLLM speech requires this key",
  },
  {
    key: "LLM_ROUTER_MODE",
    ...
    secret: false,
    placeholder: "freellmapi",
    help: "Use freellmapi for pinned-Gemini reasoning, or direct for immediate OpenAI rollback. RFC 0010 visual QA is always direct OpenAI.",
    fallback: "freellmapi is used for reasoning",
  },
  {
    ...
    secret: false,
    placeholder: "true",
    help: "When true, a FreeLLMAPI reasoning outage or quota error retries through direct OpenAI.",
    fallback: "true",
  },
  {
  ...
  },
  {
    ...
    help: "Concrete Google Gemini model for production reasoning agents. RFC 0010 rejects auto/auto:* routing to prevent silent quality degradation.",
  ...
  },
  {
    ...
    secret: true,
    placeholder: "sk-…",
    help: "Required for authoritative RFC 0010 visual QA and pre-TTS moderation; also used for reasoning fail-open/direct mode.",
    fallback: "RFC 0010 visual QA and pre-TTS moderation are unavailable without it",
  },
  {
    key: "OPENAI_MODEL",
    label: "OpenAI reasoning fallback model",
    secret: false,
    placeholder: "gpt-5.6-luna",
    help: "Paid OpenAI model used for reasoning fail-open/direct mode and as the default visual-QA model when OPENAI_IMAGE_QA_MODEL is unset.",
